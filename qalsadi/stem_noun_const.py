...
COMP_SUFFIX_LIST_TAGS = {
    ...
    #u"هُمَا":{'tags':(u"مضاف",  'لايجر' ), "vocalized":(u"هُمَا", ), },
    ...
    #u"هُمْ":{'tags':(u"مضاف",  'لايجر'), "vocalized":(u"هُمْ", ), },
    ...
    #u"هُنَّ":{'tags':(u"مضاف",  'لايجر' ), "vocalized":(u"هُنَّ", ), },
    ...
    #u"هُ":{'tags':(u"مضاف",  'لايجر'), "vocalized":(u"هُ", ), },
...
CONJ_SUFFIX_LIST_TAGS = {
    ...
    u"ٌ": {
        'tags': ('مرفوع', 'متحرك', u"تنوين"),
        'vocalized': (u"ٌ", )
    },  #DAMMATAN,
    'ٍ': {
        'tags': ('مجرور', 'متحرك', u"تنوين"),
        'vocalized': ('ٍ', )
    },  # KASRA,
    'ِ': {
        'tags': (
    ...
    u"ة": {
        'tags': ('مؤنث', 'يعرب'),
        'vocalized': (u"َةُ", u"َةٌ", 'َةٍ', 'َةِ', 'َةَ', u"َةً")
    },  #TEH_MARBUTA,
    u"َةُ": {
        'tags': (
            'مؤنث',
    ...
    u"َةٌ": {
        'tags': ('مؤنث', 'مرفوع', 'متحرك', u"تنوين"),
        'vocalized': (u"َةٌ", )
    },  #TEH_MARBUTA,
    'َةٍ': {
        'tags': ('مؤنث', 'مجرور', 'متحرك', u"تنوين"),
        'vocalized': ('َةٍ', )
    },  #TEH_MARBUTA,
    'َةِ': {
        'tags': (
    ...
    u"َةً": {
        'tags': ('مؤنث', 'منصوب', 'متحرك', u"تنوين"),
        'vocalized': (u"َةً", )
    },  #TEH_MARBUTA,
    u"ية": {
        'tags': ('مؤنث', 'مجرور', 'منسوب', 'يعرب'),
        'vocalized': (u"ِيَّةُ", u"ِيَّةٌ", 'ِيَّةٍ', 'ِيَّةِ', 'ِيَّةَ',
                      u"ِيَّةً")
    },  #TEH_MARBUTA,
    u"ِيَّةُ": {
        'tags': (
    ...
    u"ِيَّةٌ": {
        'tags': ('مؤنث', 'مرفوع', 'متحرك', u"تنوين", 'منسوب'),
        'vocalized': (u"ِيَّةٌ", )
    },  #TEH_MARBUTA,
    'ِيَّةٍ': {
        'tags': ('مؤنث', 'مجرور', 'متحرك', u"تنوين", 'منسوب'),
        'vocalized': ('ِيَّةٍ', )
    },  #TEH_MARBUTA,
    'ِيَّةِ': {
        'tags': (
    ...
    u"ِيَّةً": {
        'tags': ('مؤنث', 'منصوب', 'متحرك', u"تنوين", 'منسوب'),
        'vocalized': (u"ِيَّةً", )
    },  #TEH_MARBUTA,
    u"ا": {
        'tags': (
    ...
    #~ u"ًا":{'tags':('تنوين', 'منصوب', 'متحرك', ), 'vocalized':('ًا', )}, #ALEF,
    u"ًا": {
        'tags': (
            'تنوين',
            'منصوب',
    ...
    #u"ت":{'tags':('مؤنث', 'مضاف', 'مجرور'), 'vocalized':('َت', )}, #TEH_MARBUTA,
    #u"يت":{'tags':('مضاف', 'مجرور'), 'vocalized':('َيَّتَ', )}, #YEH+TEH_MARBUTA,
    u"ات": {
    ...
    'ي': {
        'tags': (),
        'vocalized': ('ِي', 'َيْ', 'ِيُّ', 'ِيٌّ', 'ِيَّ', 'ِيِّ',
                      'ِيٍّ')
    },  #YEH,
    'يا': {
        'tags': ('منسوب', 'منصوب', 'تنوين'),
        'vocalized': ('يا', 'ِيًّا')
    },  #YEH,
    'ِيًّا': {
        'tags': ('منسوب', 'منصوب', 'تنوين'),
    ...
    'ِيٍّ': {
        'tags': ('منسوب', 'مجرور', 'تنوين'),
        'vocalized': ('ي', )
    },  #YEH,
    u"ان": {
        'tags': ('مثنى', 'لايضاف', 'مرفوع'),
        'vocalized': ('َانِ', )
    },  #ALEF+NOON,
    'َانِ': {
        'tags': ('مثنى', 'لايضاف', 'مرفوع'),
