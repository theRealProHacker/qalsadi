...
CONJ_SUFFIX_LIST_TAGS = {
    ...
    #u"ً":{'tags':('منصوب', u"تنوين"), 'vocalized':(u"ً",)},#TEH_MARBUTA,
    u"ة": {
        'tags': ('مؤنث', 'مجرور'),
    ...
    u"َةٌ": {
        'tags': ('مؤنث', 'مرفوع', u"تنوين"),
        'vocalized': (u"َةٌ", )
    },  #TEH_MARBUTA,
    'َةٍ': {
        'tags': ('مؤنث', 'مجرور', u"تنوين"),
        'vocalized': ('َةٍ', )
    },  #TEH_MARBUTA,
    'َةِ': {
        'tags': ('مؤنث', 'مجرور'),
    ...
    u"ِيَّةُ": {
        'tags': ('مؤنث', 'مرفوع', 'منسوب'),
        'vocalized': (u"ِيَّةُ", )
    },  #TEH_MARBUTA,
    u"ِيَّةٌ": {
        'tags': ('مؤنث', 'مرفوع', u"تنوين", 'منسوب'),
        'vocalized': (u"ِيَّةٌ", )
    },  #TEH_MARBUTA,
    'ِيَّةٍ': {
        'tags': ('مؤنث', 'مجرور', u"تنوين", 'منسوب'),
        'vocalized': ('ِيَّةٍ', )
    },  #TEH_MARBUTA,
    'ِيَّةِ': {
        'tags': ('مؤنث', 'مجرور', 'منسوب'),
    ...
    'ِيَّةَ': {
        'tags': ('مؤنث', 'منصوب', 'منسوب'),
        'vocalized': ('ِيَّةَ', )
    },  #TEH_MARBUTA,
    u"ِيَّةً": {
        'tags': ('مؤنث', 'منصوب', u"تنوين", 'منسوب'),
        'vocalized': (u"ِيَّةً", )
    },  #TEH_MARBUTA,
    u"ا": {
        'tags': (
